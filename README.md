...
系統涵蓋全聯與其他通路進銷存、出貨單、採收規劃、田間工作紀錄、網室狀態、每日菜量、採菜單、留言與照片、帳號權限管理。
...
配合手機端使用PWA，方便在田間就能記錄及更新網室中種植狀態資訊
![](PWA手機畫面.png)
![](網室狀態紀錄)

將預估採收日期及預估採收重量製作成每日菜量預估表格，方便管理採收資訊
![](每日菜量表.png)

製作實際採收量及庫存表格，了解庫存及可出貨數量
![](採收規劃頁面.png)

匯入每日進銷存資料，掌握門市中庫存及銷售資訊
![](出貨進銷存頁面.png)
